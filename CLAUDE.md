...
This project is indexed by GitNexus as **bulk** (636 symbols, 1066 relationships, 46 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/bulk/context` | Codebase overview, check index freshness |
| `gitnexus://repo/bulk/clusters` | All functional areas |
| `gitnexus://repo/bulk/processes` | All execution flows |
| `gitnexus://repo/bulk/process/{name}` | Step-by-step execution trace |
